...
with st.container(border=True):
    ...
    st.markdown("""
        ...
        Types of Unsupervised Machine Learning include:
        ...
        * **Clustering:** Grouping data points into clusters of similar observations
        ...
        This application includes Principal Component Analysis (PCA) for Dimenstionality Reduction, or KMeans Clustering and Hierarchical Clustering for Clustering.""")
...
* Breast Cancer Wisconsin [learn more [here](https://scikit-learn.org/stable/api/sklearn.datasets.html)]

:bulb: **Tip:** Information about the datasets is also available on the home page. To view relevant information about each demo dataset, select a dataset from the left sidebar, navigate to the "Dataset Preview" section, and hit the 'ℹ️ Info' tab.
""")
...
Special thanks to baselhusam on GitHub, and his app ClickML available on [GitHub](https://github.com/baselhusam/ClickML/tree/main) and [Streamlit Community Cloud](https://clickml.streamlit.app/?ref=streamlit-io-gallery-other). The design and code of this application informed the making of this machine learning app.
""")
